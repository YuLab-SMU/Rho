...
| `design/active-2026-08-14-plugin-runtime-phase-2-workspace-third-party-design.md` | active; P2-0/pure contracts complete; owner authorized the complete Phase 2 end state 2026-08-20; P2-1 source/local macOS evidence complete with Windows/Linux hosted acceptance open; P2-2A-F source/local macOS complete at `0.4.1-dev.3`/`rho.bridge 0.1.15`; P2-3A-E source/local macOS complete at `0.4.1-dev.4`/`rho.agent 0.1.6`; P2-4A-D2 source/local packaged smoke complete at `0.4.1-dev.8`, with D2 Browser visual review open; D3 and later slices inactive; hosted/cross-platform gates remain open | project-local third-party workspace plugin discovery, manifest/digest, isolated host, broker-mediated permission grants, constrained handles, UI contributions, audit, disable/uninstall, and upgrade | D2 owns exact plugin→trash/tombstone and restore→disabled truth only; Browser visual evidence, permanent deletion/install/update/rollback remain open/inactive; no plugin/Agent authority expands |
...
| `plans/active-2026-08-20-p2-4-plugin-lifecycle-recovery-upgrade-spec.md` | active under owner-approved local-first exception; P2-4A-D2 source/local packaged smoke complete at `0.4.1-dev.8`; D2 Browser visual review remains open after local-file URL policy rejection; no work package active at the D2 stop; hosted/cross-platform gates remain open | schema v14 durable state/transitions/events/tombstones, immutable package cache, enable/restart, disable/crash/retry, recoverable uninstall, upgrade CAS and rollback, installed Phase 2 audit | D2 atomically joins D1 ownership with tombstone/terminal truth, revokes exact grants, and restores disabled; D3/permanent delete and E update/rollback remain inactive |
