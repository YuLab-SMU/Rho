...
| `design/active-2026-08-14-plugin-runtime-phase-2-workspace-third-party-design.md` | active; P2-0/pure contracts complete; owner authorized the complete Phase 2 end state 2026-08-20; P2-1 source/local macOS evidence complete with Windows/Linux hosted acceptance open; P2-2A-F source/local macOS complete at `0.4.1-dev.3`/`rho.bridge 0.1.15`; P2-3A-E source/local macOS complete at `0.4.1-dev.4`/`rho.agent 0.1.6`; P2-4A-D3 packaged and E1 source checkpoints complete at `0.4.1-dev.8`, with D2 Browser visual review open; E2 trusted Update active; later slices inactive; hosted/cross-platform gates remain open | project-local third-party workspace plugin discovery, manifest/digest, isolated host, broker-mediated permission grants, constrained handles, UI contributions, audit, disable/uninstall, and upgrade | E2 owns only current discovered candidate, exact expected-old Update transition, fresh candidate grants, fixed trusted UI and post-terminal old-grant revoke; no install/remote update/publisher trust/Rollback |
...
| `plans/active-2026-08-20-p2-4-plugin-lifecycle-recovery-upgrade-spec.md` | active under owner-approved local-first exception; P2-4A-D3 packaged and E1 source checkpoints complete at `0.4.1-dev.8`; D2 Browser visual review remains open after local-file URL policy rejection; E2 trusted Update active; hosted/cross-platform gates remain open | schema v14 durable state/transitions/events/tombstones, immutable package cache, enable/restart, disable/crash/retry, recoverable uninstall, upgrade CAS and rollback, installed Phase 2 audit | E2 exact local candidate/fresh grants/expected-old CAS/fixed UI only; old grants revoke after terminal; E3 Rollback and install/remote update remain inactive |
