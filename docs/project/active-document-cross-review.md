...
| `plans/active-2026-08-09-agent-conversation-concurrency-spec.md` | active; Issue #5 authorized end-to-end 2026-08-09; CONV-1 source checkpoint accepted 2026-08-09; CONV-2/CONV-3 inactive | durable project-scoped Agent Conversation identity, exact-thread context, bounded multi-turn admission, per-turn cancellation/approval isolation, and broker resource scheduling | schema-v12 Conversation identity/switching evidence is recorded while single-turn admission remains enforced; CONV-2/CONV-3 require their own activation and mandatory reviews |
