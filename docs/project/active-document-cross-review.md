...
| `design/active-2026-08-14-plugin-runtime-phase-2-workspace-third-party-design.md` | active; P2-0/pure contracts complete; owner authorized the complete Phase 2 end state 2026-08-20; P2-1 source/local macOS evidence complete with Windows/Linux hosted acceptance open; P2-2A-F source/local macOS complete at `0.4.1-dev.3`/`rho.bridge 0.1.15`; P2-3A-E source/local macOS complete at `0.4.1-dev.4`/`rho.agent 0.1.6`; P2-4A/B/C/D1 local stops complete at `0.4.1-dev.7`; D2 trusted recoverable Uninstall/Restore active; hosted/cross-platform gates remain open | project-local third-party workspace plugin discovery, manifest/digest, isolated host, broker-mediated permission grants, constrained handles, UI contributions, audit, disable/uninstall, and upgrade | D2 owns exact plugin→trash/tombstone and restore→disabled truth only; permanent deletion/install/update/rollback remain inactive; no plugin/Agent authority expands |
...
| `plans/active-2026-08-20-p2-4-plugin-lifecycle-recovery-upgrade-spec.md` | active under owner-approved local-first exception; P2-4A/B/C/D1 complete locally at `0.4.1-dev.7`; D2 Uninstall/Restore active; later packages inactive; hosted/cross-platform gates remain open | schema v14 durable state/transitions/events/tombstones, immutable package cache, enable/restart, disable/crash/retry, recoverable uninstall, upgrade CAS and rollback, installed Phase 2 audit | D2 must atomically join D1 ownership with tombstone/terminal truth, revoke exact grants, and restore disabled; no permanent delete/install/update/rollback |
