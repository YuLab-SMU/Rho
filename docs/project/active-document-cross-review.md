...
| `release/active-0.4.0-dev.26-candidate-checklist.md` | active replacement-candidate record; Issue #5 behavior source/review, bounded Windows contract portability repair, upstream integration, exact two-platform candidate, and immutable Draft assembly pass; installed acceptance, MAC5, and publication remain open | sole `0.4.0-dev.26` identity, exact-candidate evidence, installed-acceptance ledger, and GO/NO-GO decision | run `31337666426` binds both platforms to upstream `a5fc4a153bb420968155984bf8e980973c775015`; the checked-in ledger owns date/result/deviations while public schema v1 remains a minimal exact-candidate binding; hosted, installed, MAC5, and publication facts remain separate |
...
| `plans/active-2026-08-09-agent-conversation-concurrency-spec.md` | active; Issue #5 authorized end-to-end 2026-08-09; CONV-1 through CONV-3 source checkpoints, independent R3 review, upstream integration, replacement exact-commit candidate CI, and immutable Draft assembly pass; the first candidate remains rejected by its Windows CRLF-only source-contract assertion | durable project-scoped Agent Conversation identity, exact-thread context, bounded multi-turn admission, exact-turn cancellation/approval isolation, broker resource scheduling, Retry, selected-Conversation deletion, project-transition ordering, and its bounded cross-platform validation repair | owner-installed acceptance and Issue closure remain; the repair normalizes logical test input only and does not move file-edit, AFO-1, BH4, Workspace, environment, release, schema, or credential authority |
...
`0.4.0-dev.26` checklist owns its replacement identity. Its exact-source
matrix, cross-platform artifacts, and immutable Draft pass under run
`31337666426`; it must still earn its own installed-acceptance ledger. No
earlier run, notarization receipt, hash, or artifact is composable with it.
