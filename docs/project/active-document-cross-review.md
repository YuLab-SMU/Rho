...
| `design/active-2026-08-14-plugin-runtime-phase-2-workspace-third-party-design.md` | active; P2-0/pure contracts complete; owner authorized the complete Phase 2 end state 2026-08-20; P2-1 source/local macOS evidence complete with Windows/Linux hosted acceptance open; P2-2A-F source/local macOS complete at `0.4.1-dev.3` and `rho.bridge 0.1.15` with hosted/cross-platform gates open; P2-3A-D locally complete at `0.4.1-dev.4`/`rho.agent 0.1.6`, P2-3E active under local-first exception | project-local third-party workspace plugin discovery, manifest/digest, isolated host, broker-mediated permission grants, constrained handles, UI contributions, audit, disable/uninstall, and upgrade | Wasm-only executable profile with no WASI/imports; capabilities and permissions remain distinct; P2-2 source presence is not hosted/three-platform acceptance; P2-3/P2-4 remain sequential; marketplace/signing/publisher/update remain Phase 3 |
...
| `plans/active-2026-08-20-p2-3-controlled-contributions-spec.md` | active under owner-approved local-first exception; P2-3A-D Manifest V2/bounds, exact transactional calls, Agent Tool/Source/Skill and trusted Command/Viewer locally complete at `0.4.1-dev.4`/`rho.agent 0.1.6`; P2-3E named Panel/final teardown/installed review active; P2-1/P2-2 hosted/cross-platform gates remain open | Manifest V2, no-import Guest ABI V2 contribution loop, transactional Tool/Source/Skill/Command/Viewer/named-panel registrations, trusted rendering and Agent projection | no dynamic registration, raw DOM/HTML/Tauri, provider/process/write/arbitrary-R/credential authority; Command/Viewer frontend supplies no trusted identity; P2-4 retains durable lifecycle/restart/upgrade ownership |
| `plans/proposed-2026-08-20-p2-4-plugin-lifecycle-recovery-upgrade-spec.md` | proposed; complete-Phase-2 product intent authorized, activation blocked until P2-1/P2-2/P2-3 acceptance | schema v14 durable state/transitions/events/tombstones, immutable package cache, enable/restart, disable/crash/retry, recoverable uninstall, upgrade CAS and rollback, installed Phase 2 audit | no generic plugin storage/install/marketplace/signing/remote update; dedicated destructive lane and BH2/BH4 ownership preserved; final acceptance requires exact three-platform evidence |
