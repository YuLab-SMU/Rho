...
| `plans/active-2026-08-20-p2-3-controlled-contributions-spec.md` | active under owner-approved local-first exception; P2-3A-C Manifest V2/bounds, exact transactional calls and Agent Tool/Source/Skill integration locally complete at `0.4.1-dev.4`/`rho.agent 0.1.6`; P2-3D trusted Command/Viewer renderer active; P2-1/P2-2 hosted/cross-platform gates remain open | Manifest V2, no-import Guest ABI V2 contribution loop, transactional Tool/Source/Skill/Command/Viewer/named-panel registrations, trusted rendering and Agent projection | no dynamic registration, raw DOM/HTML/Tauri, provider/process/write/arbitrary-R/credential authority; P2-3C adds only read-only exact-project Agent projection; P2-4 retains durable lifecycle/restart/upgrade ownership |
