...
| `plans/active-2026-08-20-p2-3-controlled-contributions-spec.md` | active under owner-approved local-first exception; P2-3A/B Manifest V2, bounded schemas, Source/Panel contracts, exact contribution calls and transactional registry locally complete at `0.4.1-dev.4`; P2-3C fixture Tool/Source/Skill + Agent integration active; P2-1/P2-2 hosted/cross-platform gates remain open | Manifest V2, no-import Guest ABI V2 contribution loop, transactional Tool/Source/Skill/Command/Viewer/named-panel registrations, trusted rendering and Agent projection | no dynamic registration, raw DOM/HTML/Tauri, provider/process/write/arbitrary-R/credential authority; P2-3B added no command/UI/Agent/public protocol/schema; P2-4 retains durable lifecycle/restart/upgrade ownership |
