...
| `design/active-2026-08-14-plugin-runtime-phase-2-workspace-third-party-design.md` | active; P2-0/pure contracts complete; owner authorized the complete Phase 2 end state 2026-08-20; P2-1 source/local macOS evidence complete with Windows/Linux hosted acceptance open; P2-2A-F source/local macOS complete at `0.4.1-dev.3`/`rho.bridge 0.1.15`; P2-3A-E source/local macOS complete at `0.4.1-dev.4`/`rho.agent 0.1.6`; P2-4A-D3 source/local packaged smoke complete at `0.4.1-dev.8`, with D2 Browser visual review open; E1 replacement/pointer foundation active; later slices inactive; hosted/cross-platform gates remain open | project-local third-party workspace plugin discovery, manifest/digest, isolated host, broker-mediated permission grants, constrained handles, UI contributions, audit, disable/uninstall, and upgrade | E1 owns only hidden cached candidate plus expected-old runtime CAS and atomic pointer terminal truth; no command/UI, Update/Rollback product action, install or authority expansion |
...
| `plans/active-2026-08-20-p2-4-plugin-lifecycle-recovery-upgrade-spec.md` | active under owner-approved local-first exception; P2-4A-D3 source/local packaged smoke complete at `0.4.1-dev.8`; D2 Browser visual review remains open after local-file URL policy rejection; E1 replacement/pointer foundation active; hosted/cross-platform gates remain open | schema v14 durable state/transitions/events/tombstones, immutable package cache, enable/restart, disable/crash/retry, recoverable uninstall, upgrade CAS and rollback, installed Phase 2 audit | E1 may stage only verified cache bytes, publish only with expected-old contribution identity, and atomically compare/store accepted/rollback pointers; E2/E3 commands and UI remain inactive |
