...
| `plans/active-2026-08-18-rust-fast-development-ci-spec.md` | active; CI-FAST1 authorized 2026-08-18; implementation pending | read-only Ubuntu-stable Draft feedback, Cargo cache isolation, Draft/Ready matrix admission, and deterministic workflow enforcement | may split fast Draft feedback from the unchanged six-leg integration matrix; full matrix remains mandatory on affected `main` pushes and non-Draft PRs; PR #75 remains Draft through P1-4 |
