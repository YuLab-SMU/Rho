...
| `plans/active-2026-08-11-workbench-focus-stability-repair-spec.md` | active; Issue #33 ISSUE-33-INTERACTION-1 source implementation, review, hosted CI, PR #34 integration, browser interaction, and exact `dev.31` installed macOS interaction pass; installed Windows acceptance open | interaction-safe volatile refresh, explicit focus authority, activation preservation, and user-owned reading position across Project files/tabs, Agent, Runs, Problems, Plots/Outputs, Environment/Data Viewer, Git review, editor, Console, and Logs | WP2/WP3/UX4/Agent conversation/Environment retain data, execution, polling, selection, approval, and mutation truth; Issue #15 cursor advancement, Issue #18 modal predicate, and UX-FIX4 explicit Console focus preserved; `dev.31` was rejected by unrelated References/Rename; Windows installed gate remains open; no schema, backend, credential, filesystem, or project authority |
