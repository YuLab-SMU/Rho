...
Review date: 2026-08-18 (P1-3 Workspace Snapshot and Viewer activated)
...
| `design/accepted-2026-08-14-plugin-runtime-phase-1-internal-plugins-design.md` | accepted internal architecture; P1-0 through P1-2 Draft stop gates completed; P1-3 separately active 2026-08-18 | compiled-in first-party capability/scope/generation/effect/candidate lifecycle semantics above the Trusted Kernel; Phase 1 package boundaries and mandatory stops | only the separately active P1-3 contract may proceed; P1-4 requires independent activation; no third-party runtime, public SDK, target, compute, schema, permission, or release authority |
...
| `plans/active-2026-08-18-p1-3-workspace-snapshot-viewer-spec.md` | active; runtime `d67c294` and product migration `f16283c`; local implementation/review and affected validation passed 2026-08-18; exact-head Rust Fast pending | Workspace scope/tree publication, fixed Workspace Snapshot tool and application Viewer plugins, typed Workspace broker operation, Agent/Tauri parity, trusted viewer host injection, browser media parity, and P1-3 evidence | broker/Ark and `read_viewer_file` remain authoritative; no schema, external runtime, DOM/Tauri plugin authority, or P1-4 default switch; installed app and six-leg matrix remain P1-4 work |
...
P1-1 and P1-2 completed their Draft stop gates. P1-2 exact-head Rust Fast and
the expected compatibility-workflow skip passed. P1-3 is now active.
