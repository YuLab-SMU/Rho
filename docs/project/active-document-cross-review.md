...
| `release/historical-0.4.0-dev.24-candidate-checklist.md` | historical published candidate record; exact candidate, signed/notarized DMG, installed acceptance, MAC5 GO, protected Release run `31297462728`, and live update run `31297482853` pass | sole `0.4.0-dev.24` immutable asset/evidence binding, installed-acceptance ledger, publication evidence, and GO/RELEASED decision | preserve release/tag/update evidence; it cannot satisfy any `dev.25` source, artifact, acceptance, or publication gate |
| `release/active-0.4.0-dev.25-candidate-checklist.md` | active source-candidate record; Issue #5 CONV-1 through CONV-3 source verification passes; exact integration commit, artifact, installed acceptance, MAC5, and publication open | sole `0.4.0-dev.25` identity, future exact-candidate evidence, installed-acceptance ledger, and GO/NO-GO decision | reviewed source checkpoint first; hosted, installed, and publication actions remain separate factual gates |
...
| `plans/active-2026-08-09-agent-conversation-concurrency-spec.md` | active; Issue #5 authorized end-to-end 2026-08-09; CONV-1 through CONV-3 source checkpoints and independent R3 review accepted | durable project-scoped Agent Conversation identity, exact-thread context, bounded multi-turn admission, exact-turn cancellation/approval isolation, broker resource scheduling, Retry, selected-Conversation deletion, and project-transition ordering | installed/integration/CI gates remain; implemented file editing retains placement/atomic mutation/Undo, AFO-1 retains exact-turn authorization, BH4 retains deletion truth, and Workspace/environment authorities do not move |
...
Issue #5 now advances source to `0.4.0-dev.25`; none of the immutable `dev.24`
artifact or acceptance evidence is reusable for that successor.
...
installed, publication, and update evidence. The active `0.4.0-dev.25`
checklist owns Issue #5's successor identity and must earn its own exact-source
...
Those facts remain historical and do not satisfy the active `dev.25` contract.
