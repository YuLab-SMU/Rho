...
foundation and P2-4B2 durable first enable at `0.4.1-dev.5` passed their local
stops under the local-first exception; P2-4B3 restart reconstruction is active
and later P2-4 slices remain gated
